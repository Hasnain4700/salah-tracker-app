...
<head>
  ...
  <script type="module">
    ...
    import { getDatabase, ref, set, get, onValue, update, runTransaction } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-database.js";
...
<body>
  <button id="logout-btn"
    style="position:fixed;top:18px;right:18px;z-index:1001;display:none;background:#222;color:#6ee7b7;border:none;border-radius:16px;padding:8px 18px;font-size:1em;font-weight:600;box-shadow:0 2px 8px #0002;cursor:pointer;">Logout</button>
    ...
    <div id="home-partner-widget" class="card"
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;">
        <div style="display:flex;align-items:center;gap:10px;">
          <div id="hp-avatar" style="font-size:1.5em;">👤</div>
        ...
        <div style="font-size:1.2em;color:#6ee7b7;">🤝</div>
      </div>
    </div>
  ...
  <div class="container" id="donate-section" style="display:none">
    <div class="card donate-card" style="text-align:center;">
      ...
      <div style="margin-bottom:14px;font-size:1.13em;line-height:1.5;">Har week sirf <b>100 rupay</b> kisi ki zindagi
        badal sakte hain! Sadqa dein, barakat paayen.</div>
      ...
      <button id="donate-mark-btn" class="thirty-day-btn"
        style="margin-bottom:14px;width:100%;background:#6ee7b7;color:#222;">I have donated (Mark as Done)</button>
      ...
      <div style="margin-top:12px;font-size:1.01em;color:#a7f3d0;">"Jo shakhs kisi mohtaj ki madad karta hai, Allah uski
        madad karta hai." (Muslim)</div>
    </div>
  </div>
  ...
  <div class="container" id="tracker-section" style="display:none">
    ...
    <div class="stat-card-premium tier-1">
      ...
      <div class="xp-footer">
        <div id="streak-badges-row" style="font-size: 0.85em; color: #fcd34d;">🔥 <span id="streak-count">0</span> Day
          Streak</div>
    ...
    <div class="stat-card-premium history-card-wrap">
      <div class="history-card-header">
        ...
        <div class="history-menu-dots">•••</div>
      </div>
    ...
    <button id="good-deed-btn" class="good-deed-btn-premium">
      <span class="gd-icon">🌟</span> Good Deed Cards
    </button>
  </div>
  ...
  <div class="container" id="more-section" style="display:none">
    ...
    <div class="card" style="text-align:center;margin-bottom:16px;">
      <h2 style="display:flex;align-items:center;gap:8px;justify-content:center;"><span
          style="font-size:1.3em;">💖</span> <span>Dil Ki Dawa</span></h2>
      ...
      <div id="mood-buttons" style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:16px;">
        <button class="thirty-day-btn mood-btn" data-mood="sad" style="background:#334155;">😢 Sad</button>
        <button class="thirty-day-btn mood-btn" data-mood="anxious" style="background:#334155;">😰 Anxious</button>
        <button class="thirty-day-btn mood-btn" data-mood="happy" style="background:#334155;">😊 Happy</button>
        <button class="thirty-day-btn mood-btn" data-mood="angry" style="background:#334155;">😡 Angry</button>
        <button class="thirty-day-btn mood-btn" data-mood="lazy" style="background:#334155;">😴 Lazy</button>
        <button class="thirty-day-btn mood-btn" data-mood="lonely" style="background:#334155;">💔 Lonely</button>
      </div>
        ...
        <div id="twins-active" style="display:none;">
          ...
          <div
            ...
            <button id="twins-nudge-btn"
              style="background:#f59e0b;color:#222;border:none;border-radius:50%;width:40px;height:40px;font-size:1.2em;cursor:pointer;box-shadow:0 4px 12px #f59e0b40;">🔔</button>
          </div>
  ...
  <script>
    if ('serviceWorker' in navigator) {
      window.addEventListener('load', () => {
        // Register the firebase-messaging-sw which now handles both Caching and Messaging
        navigator.serviceWorker.register('./firebase-messaging-sw.js')
          .then(reg => console.log('Universal SW Registered!', reg.scope))
  ...
  <div id="onboarding-modal"
    ...
    <div id="onboarding-step-1" class="onboarding-step" style="display:flex;">
      ...
      <button class="onboarding-btn" id="btn-onboarding-permit">Enable Notifications 🔔</button>
    ...
    <div id="onboarding-step-2" class="onboarding-step">
      ...
      <div class="onboarding-input-group">
        ...
        <div style="font-size:0.75em; color:#64748b; margin-top:4px;">Hum is namaz par zyada focus karenge. 💪</div>
      </div>
    ...
    <div id="onboarding-step-3" class="onboarding-step">
      ...
      <button class="onboarding-btn" id="btn-onboarding-finish">Get Started 🚀</button>
    </div>
